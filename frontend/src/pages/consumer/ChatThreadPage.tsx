...
const API = "https://fyp-25-s4-20.duckdns.org:3000/api/chats";
...
export default function ChatThreadPage() {
  ...
  const handlePurchase = async () => {
    ...
    try {
      const res = await axios.post(
        `https://fyp-25-s4-20.duckdns.org:3000/api/products/listings/${thread.listing_id}/purchase`,
        { buyerId: userId }
      );
      if (res.data.success) {
  ...
  const handleSubmitReview = async () => {
    ...
    try {
      const res = await axios.post(
        `https://fyp-25-s4-20.duckdns.org:3000/api/reviews`,
        {
  ...
  const handleReportSeller = async () => {
    ...
    try {
      const res = await axios.post(`https://fyp-25-s4-20.duckdns.org:3000/api/chats/${threadId}/report`, {
        userId,
        reason: reportReason,
      });
      if (res.data.success) {
